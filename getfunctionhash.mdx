...
Most commonly used to fingerprint a function so a later hash mismatch reveals it was hooked or replaced, or to confirm a `clonefunction{:luau}` copy still matches the function it was cloned from.

## Parameters

| Parameter | Type | Description |
|-----------|------|-------------|
| `func` | `function{:luau}` | The Luau function to hash. |
