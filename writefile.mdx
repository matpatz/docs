...
`path{:luau}` is workspace-relative. Don't put `"workspace/"{:luau}` in front of it, and `"../"{:luau}` won't get you out of the sandbox.
...
import pfpLaquf from '../../../assets/6f9c13350ab0bea3719bd99c3575e577.webp';
