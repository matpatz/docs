...
- `"md5"{:luau}` - 32-character digest
- `"sha1"{:luau}` - 40-character digest
- `"sha256"{:luau}` - 64-character digest
- `"sha384"{:luau}` - 96-character digest
- `"sha512"{:luau}` - 128-character digest
- `"sha3-256"{:luau}` - 64-character digest
- `"sha3-512"{:luau}` - 128-character digest
