...
This is the real "remove all my drawings" call. It is not the same function as `cleardrawcache{:luau}` - that one only clears an internal cache and leaves your drawings alive.
