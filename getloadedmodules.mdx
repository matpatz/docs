...
`{ModuleScript}{:luau}` - an array of every loaded `ModuleScript{:luau}`. Every time you call `getloadedmodules{:luau}`, it will give you a new array - edits don't carry between calls.
